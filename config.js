...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "FSNBwArI#xzotlHrFyXqk-fyQV3AEviqrfcODaSNth8BgBDw-UyA",
    ...
    DEV: process.env.DEV || "27646838003", //replace with your whatsapp number
